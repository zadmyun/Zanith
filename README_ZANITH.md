...
See [`BUILD_WINDOWS.md`](BUILD_WINDOWS.md). A GitHub Actions workflow is included that produces both a portable Windows x64 package and an Inno Setup `.exe` installer.
