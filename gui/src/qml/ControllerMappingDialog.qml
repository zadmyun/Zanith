...
DialogView {
    ...
    buttonText: root.zt("Update Controller Mapping", "Atualizar mapeamento do controle")
    ...
    Item {
        ...
        CheckBox {
            ...
            text: root.zt("Allow mapping analog sticks and L2/R2", "Permitir mapear analógicos e L2/R2")
        ...
        Dialog {
            ...
            title: root.zt("Button Capture", "Captura de botão")
            modal: true
            ...
            Label {
                ...
                id: buttonLabel
                text: root.zt("Press any ", "Pressione qualquer ") + Chiaki.currentControllerType + root.zt(" button to map to DualSense controller button or click close", " botão para mapear para um botão do DualSense ou clique em fechar")
            }
        }
