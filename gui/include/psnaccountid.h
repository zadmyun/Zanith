...
namespace PSNAuth {
    // Credentials must be supplied by the builder; never commit them.
    static QString CLIENT_ID = qEnvironmentVariable("ZANITH_PSN_CLIENT_ID");
    static QString CLIENT_SECRET = qEnvironmentVariable("ZANITH_PSN_CLIENT_SECRET");
